                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'Nombres'">{{ trans('admin.usuario.columns.Nombres') }}</th>
                                        <th is='sortable' :column="'Apellidos'">{{ trans('admin.usuario.columns.Apellidos') }}</th>
                                        <th is='sortable' :column="'Usuario'">{{ trans('admin.usuario.columns.Usuario') }}</th>
